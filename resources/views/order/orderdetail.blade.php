...
@section('content')
    ...
    @if ($order_status == 1)
        ...
        <button class="btn btn-danger"><a href="/alipay/{{$order_num}}" style="text-decoration: none; color: #ffffff;">支付宝支付</a></button>
        <button class="btn btn-danger"><a href="/wx_pay/{{$order_num}}" style="text-decoration: none; color: #ffffff;">微信支付</a></button>
